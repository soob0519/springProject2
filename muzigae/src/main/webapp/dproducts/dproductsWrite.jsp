 ...
 <body>
	...
	<table class="table1">
		...
		<tr>
			...
			<td><input type="text" id="item" name="item" class="input1" autofocus></td>
		</tr>
		<tr>
			<td style="background-color: #e7e7e7;"><label for="seqid">제품코드</label></td>
			<td><input type="text" id="seqid" name="seqid" class="input1" ></td>
		</tr>
		...
		<tr>
			...
			<td><input type="text" id="quan" name="quan" class="input1"></td>
		</tr>
		...
		<tr>
			...
			&nbsp;
			<input type="file" id="filename1" name="file1"> <br>
			&nbsp;
			<input type="file" id="filename" name="file2"> <br>
			&nbsp;
			<input type="file" id="filename" name="file3">
			</td>
		</tr>
		
		
		<tr>
			<td style="background-color: #e7e7e7;"><label for="content">설명</label></td>
