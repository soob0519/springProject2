	...
	<body>
		...
		<div class="page_path wrap">
			<ul class="flex_end">
				...
				<li>
					<strong><a href="/prodFaceList">face</a></strong>
				</li>
			</ul>
		</div>
			...
			<section>
				...
				<div>
					<ul class="prod_category flex_center">
						...
						<li><strong><a href="/prodFaceList">FACE</a></strong></li>
					</ul>
				</div>
			</section>
		</article>
		...
		<article class="contents_items wrap">
			...
			<section class="prod_total">
				...
				<ul class="prod_total_items flex_start">
					...
					<li>
						<a href="/prodDetail/${face.RSEQID }" class="prod_total_item1">
							<img src="../images/prod_thumbnail/${face.FILE1 }">
							<div class="flex_between">
								<span class="prod_name">${face.PNAME }</span>
								<span class="prod_price">${face.PRICE }</span>
							</div>
						</a>
					</li>
					</c:forEach>
