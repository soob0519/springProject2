	...
	<body>
		...
		<div class="page_path wrap">
			<ul class="flex_end">
				...
				<li>
					<strong><a href="/prodTotalList">shop</a></strong>
				</li>
			</ul>
		</div>
		...
		<article class="contents_items wrap">
			...
			<section class="prod_total">
				...
				<ul class="prod_total_items flex_start">
					...
					<li>
						<a href="/prodDetail/${total.RSEQID }" class="prod_total_item1">
							<img src="../images/prod_thumbnail/${total.FILE1 }">
							<div class="flex_between">
								<span class="prod_name">${total.PNAME }</span>
								<span class="prod_price">${total.PRICE }</span>
							</div>
						</a>
					</li>
					</c:forEach>
