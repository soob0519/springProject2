	...
	<body>
		...
		<div class="page_path wrap">
			<ul class="flex_end">
				...
				<li>
					<strong><a href="/prodLipList">lip</a></strong>
				</li>
			</ul>
		</div>
			...
			<section>
				...
				<div>
					<ul class="prod_category flex_center">
						<li><strong><a href="/prodLipList">LIP</a></strong></li>
						<li><a href="prodEyeList">EYE</a></li>
		...
		<article class="contents_items wrap">
			...
			<section class="prod_total">
				...
				<ul class="prod_total_items flex_start">
					<!-- 전체상품 : 모든 상품 리스트.. -->
					<c:forEach var="lip" items="${lipList }">
					<li>
						<a href="/prodDetail/${lip.RSEQID }" class="prod_total_item1">
							<img src="../images/prod_thumbnail/${lip.FILE1 }">
							<div class="flex_between">
								<span class="prod_name">${lip.PNAME }</span>
								<span class="prod_price">${lip.PRICE }</span>
							</div>
						</a>
					</li>
					</c:forEach>
