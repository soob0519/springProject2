...
<header id="header">
		...
		<article class="contents wrap">
			...
			<section class="prod_new1 wrap">
				<h3 class="prod_h3">취소내역</h3>
				<c:forEach var="can" items="${cancleList}">
					<a href="/pcDetail/${can.BSEQID}">
					<ul class="prod_new_items">
						<li>
							...
							<div class="list2 flex_start">
								...
								<span>구매날짜 ${can.PDATE}</span>
								<span>총가격 ${can.PRICE}</span>
							</div>
						</li>
					</ul>
					</a>
